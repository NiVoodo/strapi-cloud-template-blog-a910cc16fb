...
const buildPrompt = (context) => {
  const instructions = [
    ...
    'Generiere ein vollständiges Schema.org JSON-LD für die Seite (inkl. name, description, url, datePublished, dateModified, publisher, mainEntity, breadcrumb, about/mentions).',
  ...
  const schema = {
    ...
    structuredData: {
      ...
      '@type': 'WebPage|Article|Event je nach Inhalt',
      name: 'string',
      description: 'string',
      url: 'absolute URL',
      ...
      publisher: {
        '@type': 'Organization',
        name: 'string',
        logo: { '@type': 'ImageObject', url: 'absolute URL' },
      },
      mainEntity: { '@type': 'Thing oder passende Entität', name: 'string', url: 'absolute URL' },
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [] },
      about: [{ '@type': 'Thing', name: 'string' }],
      mentions: [{ '@type': 'Thing', name: 'string' }],
    },
